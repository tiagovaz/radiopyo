...
def generate_songs(src: str, output: str, format: str, force: bool) -> NoReturn:
    ...
    for script in all_songs:
        ...
        if song_name != '__init__' and not force and song_name not in generated_songs:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output', default='./songs/', help='Output folder to store all scripts')
